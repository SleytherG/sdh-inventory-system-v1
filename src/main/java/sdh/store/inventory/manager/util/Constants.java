...
public class Constants {
    ...
    public static final String SALES_CREATED_SUCCESSFULLY = "Sales created successfully";
    public static final String EXIT = "EXIT";
    public static final String FACTURA = "FACTURA";
    public static final String NOT_ENOUGH_STOCK_PRODUCT = "There is not enough stock for the product with ID";
}
